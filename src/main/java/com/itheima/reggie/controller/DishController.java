...
public class DishController {
    ...
    public R<Page> page(int page, int pageSize, String name) {
        ...
        List<Dish> record1 = page1.getRecords();
        List<DishDto> dishDtos = record1.stream().map((item) -> {
    ...
    public R<String> changeSelling(@PathVariable Integer status,@RequestParam List<Long> ids) {
